...
<?php
    $login_form = <<<EOD
<form name="login" id="login" method="POST" action="check_admin_login.php">
 <p>Username<br><input type="text" name="username"><br></p>
 <p>Password<br><input type="password" name="password"><br></p>
 <p><input type="submit" name="submit" id="submit" value="Submit"/><br><br><input type="reset" name="reset" id="reset" value="Reset"/></p>
</form>
EOD;
echo "<loginInfo>";
$msg = $_GET['msg'];  //GET the message
if($msg!='') echo '<p>'.$msg.'</p>'; //If message is set echo it
echo "<h1>Enter Your Login Information Below</h1>";
echo $login_form;
?>
</loginInfo>
