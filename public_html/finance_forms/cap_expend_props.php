...
<html>
  <head>
  <title>New Capital Expenditure Proposal</title>
  ...
  <style type="text/css">
    ...
    <div id="header">
      ...
      <p>New Capital Expenditure Proposal</p>
    </div>
    <div id="form">
      <form action= "cap_expend_prop.php" method="post">
        <div class="row">
          <div class="triplecolumn">
            ...
            <p>Type of Request<br>
              <input type="text" name="reqType"><br>
        ...
        <div class="triplecolumn">
          ...
          <p>Request Description<br>
            <textarea rows="3" cols="30" name="reqComments"></textarea>
          </p>
        </div>
        <div class="triplecolumn">
          <p>Last Name<br>
