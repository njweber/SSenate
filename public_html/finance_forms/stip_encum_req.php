...
<?php
    ...
    $dbc = ("INSERT INTO stip_encum_request_pending(Student_ID,First_Name,Last_Name,Amount_Requested,Position,Date,Organization) 
    VALUES ('$id_number','$fName','$lName','$amount','$org_position','$date','$organization')");
