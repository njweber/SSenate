...
<body> 
  <div id="page">
            ...
            <p>Pending Line Item Shift Requests</p>
					</div>
         </div>
				</div>
		  </header>   
...
$sql = "SELECT * FROM line_shift_pending";
...
if ($result->num_rows > 0) {
    echo "<table><tr>
      ...
      <th>Line Item Description</th>
      <th>Amount</th>
      <th>Total Shifted In</th>
      <th>Total Shifted Out</th>
    ...
    echo '<form method="post">';
      echo "<tr><td>".$row["Date"].
            ...
            "</td><td>".$row["InDescription1"]."<br>".$row["InDescription2"]."<br>".$row["InDescription3"]."<br>".$row["InDescription4"]."<br>".$row["InDescription5"]."<br>".$row["InDescription6"].
            
            "</td><td>".$row["InAmount1"]."<br>".$row["InAmount2"]."<br>".$row["InAmount3"]."<br>".$row["InAmount4"]."<br>".$row["InAmount5"]."<br>".$row["InAmount6"].
            
            "</td><td>".$row["OutDescription1"]."<br>".$row["OutDescription2"]."<br>".$row["OutDescription3"]."<br>".$row["OutDescription4"]."<br>".$row["OutDescription5"]."<br>".$row["OutDescription6"].
            
            "</td><td>".$row["OutAmount1"]."<br>".$row["OutAmount2"]."<br>".$row["OutAmount3"]."<br>".$row["OutAmount4"]."<br>".$row["OutAmount5"]."<br>".$row["OutAmount6"].
            
            "</td><td>".$row["TotalShiftIn"].
            "</td><td>".$row["TotalShiftOut"].
            "</td><td>".$row["Description"].
            "</td><td><button type='submit' value=".$row["Form_ID"]." name='approve'>Approve</button>
            </td><td><button type='submit' value=".$row["Form_ID"]." name='decline'>Decline</button>
            </td><td><a href='line_item_shift_request_view_pending.php?key=".$row["Form_ID"]."'class='button'>View</a></td></tr>";
	    echo '</form>';		
	}
  echo "</table>";
  } else {
...
if(isset($_POST["approve"]))
  {
    ...
    $sql2 = "SELECT * FROM line_shift_pending WHERE Form_ID = '$form_id'";
    ...
    $InDescription1 = $row2["InDescription1"];
    $InAmount1 = $row2["InAmount1"];
    $OutDescription1 = $row2["OutDescription1"];
    $OutAmount1 = $row2["OutAmount1"];
    
    $InDescription2 = $row2["InDescription2"];
    $InAmount2 = $row2["InAmount2"];
    $OutDescription2 = $row2["OutDescription2"];
    $OutAmount2 = $row2["OutAmount2"];
    
    $InDescription3 = $row2["InDescription3"];
    $InAmount3 = $row2["InAmount3"];
    $OutDescription3 = $row2["OutDescription3"];
    $OutAmount3 = $row2["OutAmount3"];
    
    $InDescription4 = $row2["InDescription4"];
    $InAmount4 = $row2["InAmount4"];
    $OutDescription4 = $row2["OutDescription4"];
    $OutAmount4 = $row2["OutAmount4"];
    
    $InDescription5 = $row2["InDescription5"];
    $InAmount5 = $row2["InAmount5"];
    $OutDescription5 = $row2["OutDescription5"];
    $OutAmount5 = $row2["OutAmount5"];
    
    $InDescription6 = $row2["InDescription6"];
    $InAmount6 = $row2["InAmount6"];
    $OutDescription6 = $row2["OutDescription6"];
    $OutAmount6 = $row2["OutAmount6"];
    
		$TotalShiftIn = $row2["TotalShiftIn"];
		$TotalShiftOut = $row2["TotalShiftOut"];
    ...
    //Grabbing info to put into approved database
    $sql2 = ("INSERT INTO line_shift_approved(Date,First_Name,Last_Name,Organization,Email,Phone_Number,          InDescription1,InAmount1,OutDescription1,OutAmount1,
    InDescription2,InAmount2,OutDescription2,OutAmount2,
    InDescription3,InAmount3,OutDescription3,OutAmount3,
    InDescription4,InAmount4,OutDescription4,OutAmount4,
    InDescription5,InAmount5,OutDescription5,OutAmount5,
    InDescription6,InAmount6,OutDescription6,OutAmount6,
    TotalShiftIn,TotalShiftOut,Description)
    VALUES('$Date','$First_Name','$Last_Name','$Organization','$Email','$Phone_Number',    
            '$InDescription1','$InAmount1','$OutDescription1','$OutAmount1',
            '$InDescription2','$InAmount2','$OutDescription2','$OutAmount2',
            '$InDescription3','$InAmount3','$OutDescription3','$OutAmount3',
            '$InDescription4','$InAmount4','$OutDescription4','$OutAmount4',
            '$InDescription5','$InAmount5','$OutDescription5','$OutAmount5',
    ...
    if (mysqli_query($conn, $sql2)) {
      ...
      $sql2 = "DELETE FROM line_shift_pending WHERE Form_ID = '$form_id'";
