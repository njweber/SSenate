...
<body> 
  <div id="page">
            ...
            <p>Pending Stipend Encumbrance Requests</p>
					</div>
         </div>
				</div>
		  </header>   
...
$sql = "SELECT * FROM stip_encum_request_pending";
$result = mysqli_query($conn, $sql);

if ($result->num_rows > 0) {
  echo "<table><tr><th>Date</th><th>ID</th><th>Name</th><th>Position</th><th>Amount Requested</th><th>Organization</th></tr>";
    ...
    echo '<form method="post">';
      echo "<tr><td>".$row["Date"].
        ...
        </td><td><a href='stip_encum_request_view_pending.php?key=".$row["Form_ID"]."'class='button'>View</a></td></tr>";
        echo '</form>';
    }
    echo "</table>";
    } else {
...
if(isset($_POST["approve"]))
  {
    ...
    $sql2 = "SELECT * FROM stip_encum_request_pending WHERE Form_ID = '$form_id'";
    ...
    $sql2 = ("INSERT INTO stip_encum_request_approved(Student_ID, First_Name, Last_Name, Amount_Requested, Position, Date, Organization)
    VALUES('$Student_ID', '$First_Name', '$Last_Name', '$Amount_Requested', '$Position', '$Date', '$Organization')");

    if (mysqli_query($conn, $sql2)) {
      echo "<p>Form inserted to approved database successfully</p>";
      
      $sql2 = "DELETE FROM stip_encum_request_pending WHERE Form_ID = '$form_id'";
