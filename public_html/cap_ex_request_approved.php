...
<body> 
  <div id="page">
            ...
            <p>Approved Capital Expenditure Proposals</p>
					</div>
         </div>
				</div>
		  </header>   
...
$sql = "SELECT * FROM cap_expend_prop_approved";
  ...
  echo "<table><tr>
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row["Date"].
            ...
            "</td><td><a href='cap_ex_request_view_approved.php?key=".$row["Form_ID"]."'class='button'>View</a></td></tr>";
    }
    echo "</table>";
} else {
    echo "0 results";
