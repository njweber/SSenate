...
<body> 
  <div id="page">
            ...
            <p>Approved Information Forms</p>
					</div>
         </div>
				</div>
		  </header>   
...
$sql = "SELECT * FROM information_form_approved ORDER BY Organization";
  ...
  echo "<table><tr><th>ID</th><th>Name</th><th>Email</th><th>Organization</th><th>Position</th></tr>";
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row["Student_ID"].
            ...
            "</td><td>".$row["Position"].
            "</td><td><a href='information_form_view_approved.php?key=".$row["Form_ID"]."'class='button'>View</a></td></tr>";
    }
    echo "</table>";
} else {
    echo "0 results";
