...
$sql = "SELECT * FROM information_form_pending ORDER BY Organization";
$result = mysqli_query($conn, $sql);

if($result->num_rows > 0){
    echo "<table><tr><th>ID</th><th>Name</th><th>Email</th><th>Organization</th><th>Position</th></tr>";
	      while($row = $result->fetch_assoc()) {
            ...
            </td><td><a href='information_form_view_pending.php?key=".$row["Form_ID"]."'class='button'>View</a>
            </td></tr>";
            echo '</form>';
        }
        echo "</table>";
...
if(isset($_POST["approve"]))
  {
    ...
    $sql2 = "SELECT * FROM information_form_pending WHERE Form_ID = '$form_id'";
    ...
    $sql2 = ("INSERT INTO information_form_approved(Student_ID, First_Name, Last_Name, Email, Organization, Position)
    VALUES('$Student_ID', '$First_Name', '$Last_Name', '$Email', '$Organization', '$Position')");

    if (mysqli_query($conn, $sql2)) {
      echo "<p>Form inserted to approved database successfully</p>";
      
      $sql2 = "DELETE FROM information_form_pending WHERE Form_ID = '$form_id'";
