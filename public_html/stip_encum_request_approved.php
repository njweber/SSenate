...
<body> 
  <div id="page">
            ...
            <p>Approved Stipend Encumbrance Requests</p>
					</div>
         </div>
				</div>
		  </header>   
...
$sql = "SELECT * FROM stip_encum_request_approved";
  ...
  echo "<table><tr><th>Date</th><th>ID</th><th>Name</th><th>Position</th><th>Amount Requested</th><th>Organization</th></tr>";
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row["Date"].
            ...
            "</td><td><a href='stip_encum_request_view_approved.php?key=".$row["Form_ID"]."'class='button'>View</a></td></tr>";
    }
    echo "</table>";
} else {
    echo "0 results";
