<html>
  ...
  <div id="page">
            ...
            <p>Pending Capital Expenditure Proposals</p>
					</div>
         </div>
				</div>
		  </header>   
...
$sql = "SELECT * FROM cap_expend_prop_pending";
    ...
    while($row = $result->fetch_assoc()) {
      echo '<form method="post">';
        echo "<tr><td>".$row["Date"].
            ...
            </td><td><a href='cap_ex_request_view_pending.php?key=".$row["Form_ID"]."'class='button'>View</a></td></tr>";
	    echo '</form>';
    }
    echo "</table>";
} else {
