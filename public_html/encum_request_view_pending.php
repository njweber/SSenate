<html>
  ...
  <div id="page">
            ...
            <p>Pending Encumbrance Request Form ID: 
            <?php 
            $key = $_GET['key']; 
            echo $key 
            ?>
...
$sql = "SELECT * FROM encum_req_pending WHERE Form_ID='$key'";
...
<div class='data'>
    <div class='row'>
          <div class='triplecolumn'>
            ...
            <h1>Make Check Payable To</h1>
            <h2>".$row["Check_Payable"]."</h2>
        ...
        <div class='triplecolumn'>
            ...
            <h1>Line/Category</h1>
            <h2>".$row["Line_Category"]."</h2>
            
            <h1>Check Payable ID #</h1>
            <h2>".$row["Check_ID"]."</h2>
