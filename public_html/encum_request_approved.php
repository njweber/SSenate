...
<body> 
  <div id="page">
            ...
            <p>Approved Encumbrance Requests</p>
					</div>
         </div>
				</div>
		  </header>   
...
$sql = "SELECT * FROM encum_req_approved";
  ...
  echo "<table><tr>
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row["Date"].
            ...
            "</td><td><a href='encum_request_view_approved.php?key=".$row["Form_ID"]."'class='button'>View</a></td></tr>";
    }
    echo "</table>";
} else {
    echo "0 results";
